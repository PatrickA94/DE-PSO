...
from PSO2 import opt
from figgen import make_plot, make_table

def main():
    dims = [2,5,10]

    funcs =[highCond,bentCig,discus,]
    ...
    for func in funcs:
        for dim in dims:
            ...
            #PSO
            tablesmaxp.append(tablemax)
            tablesminp.append(tablemin)
            tablesmeanp.append(tablemean)
            tablesstdp.append(tablestd)
